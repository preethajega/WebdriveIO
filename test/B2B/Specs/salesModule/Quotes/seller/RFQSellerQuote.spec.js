...
var termSettingsip = require("../../../../Inputs/settings/TermsIP");
...
describe("cart Page", () => {
    ...
    it('sample term vaidation',async () => {
        ...
        //         await Quote_fn.open()//temp
        // await browser.pause(5000)//temp
        // await quotefilter_fn.AddFilter(QuotefilterPath.AllFilterTab, QuotefilterPath.quoteId, QuoteIp.tempQuoteID)//temp
        // await browser.pause(3000)//temp
        await Quote_fn.Termsvalid(termsettingsPath.Mode,termsettingsPath.NeedApprovalFirst,termsettingsPath.ModeTermInputfitst,
            QuoteBtnPath.SelectfirstData,SidNavQuote_path.RespondBtn,Term_path.ModeOfDispatchTerm,
            QuoteBtnPath.RequestApproval,QuoteBtnPath.Comments,QuoteBTnsIp.comments,QuoteBtnPath.ConfBtn,
            SidNavQuote_path.SubmitReviewBtn,QuoteBtnPath.Comments,QuoteBTnsIp.comments,QuoteBtnPath.ConfBtn,
            termsettingsPath.NeedApprovalFirst,termsettingsPath.ModeTermInputfitst,
            QuoteBtnPath.SelectfirstData,SidNavQuote_path.RespondBtn,Term_path.ModeOfDispatchTerm,
            QuoteBtnPath.RequestApproval,QuoteBtnPath.Comments,QuoteBTnsIp.comments,QuoteBtnPath.ConfBtn,
            SidNavQuote_path.SubmitReviewBtn,QuoteBtnPath.Comments,QuoteBTnsIp.comments,QuoteBtnPath.ConfBtn)
