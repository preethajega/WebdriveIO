...
describe("Leads Page", () => {
    ...
    await  LoginPage.login(B2B_loginIp.BuyerEmail,B2B_loginIp.BuyerPassword);  
    ...
    await  cart_fn.commonEnquiryFields(CartIp.ContactNo,
        CartIp.Attachment,CartIp.suceessAlert);
    });
