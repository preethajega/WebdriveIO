...
// ************** Approver User Group Card *********************************
      ...
      it('should delete a creted User group with cancel',async () => {
        await browser.pause(2000)
         await approval_fn.DeleteUserGrp(approval_path.ConfcancelBtn,common.snackbar,approvalip.deleAlert)
      });
      it('should delete a creted User group with save',async () => {
         await approval_fn.DeleteUserGrp(approval_path.ConfSavelBtn,common.snackbar,approvalip.deleAlert)
      });
...
// ************** Range Card ***************************      
      it('should create a new Range with cancel ',async () => {
        await actionsWrappers.Click(approval_path.DeleteAprTab)
        await approval_fn.AddRange(approval_path.ConfcancelBtn)
      });
