...
describe('Team Page', () => {
  ...
  it('should not allow a user to enter the same mail in the Add user card ', async () => {
    await team_fn.AlredyExistsFieldValid(team_path.Email, teamip.email, team_path.errMail, teamip.mailexitsAlert)
  });
  ...
  it('should Add the tags to the exisiting user with cancel', async () => {
    ...
    await actionsWrappers.scrollEleAndClick(team_path.Editdata)
