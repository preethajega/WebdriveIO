...
describe('Terms Page', () => {
   ...
   it('should not allow a user to enter the same option name in Dispatch Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermName, termip.delivery, common.snackbar, termip.modeAlert)
   });
   it('should not allow a user to enter the same option name in Dispatch Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermCode, termip.deliverycode, common.snackbar, termip.codeAlert)
   });
   ...
   it('should not allow a user to enter the same option name in freight Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermName, termip.delivery, common.snackbar, termip.frightAlert)
   });
   it('should not allow a user to enter the same option name in freight Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermCode, termip.deliverycode, common.snackbar, termip.codeAlert)
   });
   ...
   it('should not allow a user to enter the same option name in INSURANCE Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermName, termip.delivery, common.snackbar, termip.insuranceAlert)
   });
   it('should not allow a user to enter the same option name in INSURANCE Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermCode, termip.deliverycode, common.snackbar, termip.codeAlert)
   });
   ...
   it('should not allow a user to enter the same option name in PACKANGING & FORWARDING Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermName, termip.delivery, common.snackbar, termip.PFAlert)
   });
   it('should not allow a user to enter the same option name in PACKANGING & FORWARDING Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermCode, termip.deliverycode, common.snackbar, termip.codeAlert)
   });
   ...
   it('should not allow a user to enter the same option name in Warrenty Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermName, termip.delivery, common.snackbar, termip.warrentyAlert)
   });
   it('should not allow a user to enter the same option name in Warrenty Term name', async () => {
      await term_fn.AllreadyExistOption(term_path.Delivery, term_path.TermCode, termip.deliverycode, common.snackbar, termip.codeAlert)
   });
